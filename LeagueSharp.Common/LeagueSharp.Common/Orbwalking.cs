            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.AddItem(
                    new MenuItem("LastHit", "Last hit").SetShared()
                        .SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Toggle, false)));

                _config.AddItem(
                    new MenuItem("Farm", "Mixed").SetShared()
                        .SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Toggle, false)));

                _config.AddItem(
                    new MenuItem("LaneClear", "LaneClear").SetShared()
                        .SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Toggle, false)));

                _config.AddItem(
                    new MenuItem("Orbwalk", "Combo").SetShared().SetValue(new KeyBind(32, KeyBindType.Toggle, false)));
